    ...
    class PrintDGV
    {
                    ...
                    System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    tmpCol = 0;
                    while (tmpCol < dgv.Columns.Count)
                    {
                        foreach (DataGridViewColumn GridCol in dgv.Columns)//----------------------------------------------------------------------------------------------
                        {
                            if ((tmpCol <= dgv.Columns.Count) && (tmpCol == GridCol.DisplayIndex))
                            {
                                tmpCol++;
                                if (!GridCol.Visible) continue;
                    ...
                    MessageBox.Show(tmpCol.ToString() + " " + ColumnWidths.Count.ToString());
                }
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            MessageBox.Show(tmpCol.ToString());
                            NewPage = false;
                            tmpTop += HeaderHeight;
                        }
                        ...
                        while (tmpCol < dgv.Columns.Count)
                        {
                            ...
                            {
                                if ((tmpCol <= dgv.Columns.Count) && (tmpCol == Cel.OwningColumn.DisplayIndex))
                                {
                                    tmpCol++;
                                    ...
                                    {
                                        if (Cel.OwningColumn.DefaultCellStyle.Alignment == DataGridViewContentAlignment.MiddleCenter)
                                            StrFormat.Alignment = StringAlignment.Center;
                                        else if (Cel.OwningColumn.DefaultCellStyle.Alignment == DataGridViewContentAlignment.MiddleRight)
                                            StrFormat.Alignment = StringAlignment.Far;
                                        else if (Cel.OwningColumn.DefaultCellStyle.Alignment == DataGridViewContentAlignment.NotSet)
                                            StrFormat.Alignment = StringAlignment.Near;
